...
function buildAssistantTicketPrompt({
  ...
  const systemPrompt = [
    ...
    "- You cannot close, rename, move, or escalate tickets in assistant-only mode.",
    "- You cannot contact staff, mention roles, change permissions, or perform server actions.",
    "",
    "Output rules:",
