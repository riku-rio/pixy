...
function buildTicketPrompt({
  ...
  const baseSystemPrompt = customSystemPrompt || [
    ...
    "- Request escalate_ticket when the user asks for staff, admin, or human support.",
    ...
    "- Use only basic Discord Markdown: bold, italics, inline code, bullet lists, and short headings.",
